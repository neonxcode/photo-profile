              ...
              <TabsContent key={category} value={category} className="mt-6 sm:mt-8 md:mt-12">
                <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-2 sm:gap-2 space-y-2 sm:space-y-2"> 
                  {photos.map((photo) => (
                    <div
                      key={photo.id}
                      className="group relative overflow-hidden bg-gray-900 hover: cursor-pointer break-inside-avoid mb-2 sm:mb-2"
                    //   className="relative overflow-hidden bg-gray-900 cursor-pointer break-inside-avoid mb-2 sm:mb-2"
                    >
                    <ImageZoom
                    backdropClassName={cn(
                      ...
                      <Image
                        ...
                        width={photo.width}
                        height={photo.height}
                        className="w-full h-auto object-contain group-hover "
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover: pointer-events-none" />
